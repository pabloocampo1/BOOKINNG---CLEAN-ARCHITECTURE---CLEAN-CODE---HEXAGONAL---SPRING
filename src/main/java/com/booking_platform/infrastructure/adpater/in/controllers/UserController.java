...
public class UserController {
    ...
    public UserController(UserMapperRest userMapperRest, RegisterUserUseCase registerUserUseCase,
            BecomeToHostUseCase becomeToHostUseCase, ShowUserInformationUseCase showUserInformation) {
    ...
    public ResponseEntity<UserResponse> getUserInformation(
        ...
        return new ResponseEntity<>(this.userMapperRest.toResponse(this.showUserInformation.execute(userId)),
                HttpStatus.OK);
    }
